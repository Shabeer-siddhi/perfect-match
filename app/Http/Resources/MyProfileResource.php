...
class MyProfileResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            'profile_verified' => $this->customer_details->is_verified,
            'government_id' => $this->customer_details->government_id ? url($this->customer_details->government_id) : '',
            'selfi_images' => $this->customer_details->selfi_images ? url($this->customer_details->selfi_images) : '', 
        ];
    }
}
